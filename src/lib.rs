...
// This code is modified and distributed by RiteLabs,
// and the copyright belongs to the original developer.
...
//! not use this hash for cryptographic purposes.  Furthermore, this hashing algorithm was
